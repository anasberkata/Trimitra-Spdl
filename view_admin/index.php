...
<div class="content">
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="index_dashboard.php?titik_lokasi=1">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="index_dashboard.php?titik_lokasi=2">
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row pb-2">
                            <div class="col-2 col-md-2">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="index_dashboard.php?titik_lokasi=3">
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row pb-2">
                            <div class="col-2 col-md-2">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="index_dashboard.php?titik_lokasi=4">
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row pb-2">
                            <div class="col-2 col-md-2">
        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header ">
                    <!-- <h5 class="card-title">Lokasi : Semua Lokasi</h5> -->
